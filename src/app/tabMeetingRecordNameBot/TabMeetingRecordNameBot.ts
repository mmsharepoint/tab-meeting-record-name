...
/**
 * Implementation for tab meeting record name Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class TabMeetingRecordNameBot extends TeamsActivityHandler {
    ...
    protected async handleTeamsTaskModuleFetch(context: TurnContext, request: TaskModuleRequest): Promise<any> {
        log(context);
        log(request);
